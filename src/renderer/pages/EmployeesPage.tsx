...
import { employeeStatusLabels } from '@/renderer/utils/labels';

export function EmployeesPage() {
  const dictionaries = useDictionaries(['employee_status']);
  const statusLabels = dictionaries.labels('employee_status', employeeStatusLabels);
  ...
  return (
    <MasterDataPage<Employee>
      ...
      fields={[
        ...
        { name: 'status', label: '员工状态', required: true, render: <Select options={dictionaries.options('employee_status', employeeStatusLabels)} /> },
